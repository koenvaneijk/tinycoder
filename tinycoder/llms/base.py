...
class LLMClient(ABC):
    ...
    # Optional: Add a streaming method to the ABC later if needed
    # @abstractmethod
    # def stream_content(self, system_prompt: str, history: List[Dict[str, str]]) -> Generator[Dict, None, None]:
    #     pass
